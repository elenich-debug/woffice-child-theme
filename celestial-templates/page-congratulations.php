<?php
/**
 * Template Name: Christmas Greeting Page (Magic V10 Final Fixed)
 */
...
<div id="magic-v10-wrapper">
    ...
    <section class="v10-hero">
        ...
        <img id="bg-image" src="http://3d-stuff.community/img/ChristBorn.png" style="position: absolute; top: 49%; left: 50%; transform: translate(-50%, -50%); width: 100%; height: 100%; object-fit: contain;">
    </section>
   ...
   <div class="v10-xmas-header">
    <div class="v10-xmas-flex-row">
        ...
        <!-- Анимированный слой снега -->
        <div class="v10-snow-wrap">
            <div class="v10-snow-layer"></div>
        </div>
...
#bg-image {
    ...
    object-fit: contain; /* Вписывает картинку целиком, не обрезая */
}
...
.v10-snow-layer {
    ...
    opacity: 0.3; pointer-events: none; animation: snowMove 25s linear infinite;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    soundBtn?.addEventListener('click', function() {
        ...
        this.querySelector('.v10-sound-text').innerText = video.muted ? 'Unmute' : 'Mute';
        this.querySelector('i').className = video.muted ? 'fa fa-volume-off' : 'fa fa-volume-up';
    });
...
// 5. Функция удаления (вне очереди)
...
// 6. Скрытие scroll-индикатора после 150px
