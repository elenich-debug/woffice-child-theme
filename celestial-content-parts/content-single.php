...
if (get_post_type() === 'request') {
    ...
    echo '<div class="note">Note: You need a <a href="https://3d-stuff.community/wiki/community-membership-structure/">Contributor </a>role or higher to fulfill requests and vote.</div>';
}
?>
