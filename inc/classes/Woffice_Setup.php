...
if( ! class_exists( 'Woffice_Setup' ) ) {
    class Woffice_Setup
    {
        ...
        public function filter_theme_fw_ext_backups_demos($demos)
        {
            $demos_array = array(
                'stellar-demo' => array(
                    'title' => __('Stellar Demo', 'woffice'),
                    'screenshot' => 'https://hub.woffice.io/storage/woffice/demos/demo-stellar.png',
                    'preview_link' => 'stellar.woffice.io/',
                )
        ...
        public function search_form($form)
{
    ...
    $form = '<div class="active_search"></div>
