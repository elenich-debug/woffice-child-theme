			...
			<div id="content-container">
				...
				<div id="content">
					<?php if (true){
						...
						<div id="wiki-nav" class="celst-tab-layout">
									<ul class="woffice-tab-layout__nav">
										...
										<?php if ($edit_allowed) { ?>
											<li id="wiki-tab-edit">
												<a href="javascript:void(0)" class="celst-form-edit-toggle"><?php _e("Edit","woffice"); ?></a>
											</li>
										<?php } ?>
										...
										<li id="wiki-tab-comments" data-tab="comments">
											<a href="javascript:void(0)" class="">
												...
												<span class="tab-badge"><?php comments_number( '0', '1', '%' ) ?></span>
											</a>
										</li>
										<?php endif; ?>
										<?php
						...
						<!-- ---------tab end--------- -->
							<div class="wiki-tabs-wrapper woffice-tab-layout__content">
								...
								<?php Woffice_Frontend::render_featured_image_single_post(get_the_ID()); ?>
									...
									<div class="post-title">
										<?php the_title('<h1 class="wiki-title">','</h1>'); ?>
									</div>
									<?php } ?>	
									<?php // THE CONTENT 
									the_content(); ?>
								...
								<?php if ($edit_allowed) { ?>
									...
									<div id="wiki-content-edit" data-tab="edit" class="woffice-tab-layout__tab celts-frontend-form-wrapper">

                                        <?php
                                        Woffice_Frontend_Celestial::frontend_render('wiki', $process_result, get_the_ID()); ?>
                                ...
                                <?php if(woffice_wiki_have_comments()) : ?>
                                    <!-- SEE THE COMMENTS-->
                                    <div id="wiki-content-comments" data-tab="comments" class="woffice-tab-layout__tab celst-comment-wrapper wiki-single-comment">
                                        <?php
